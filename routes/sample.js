...
// Leave conversation
app.intent('RebootDevice', (conv, body) => {
    console.log('====', body, '====');
    conv.add('Okay see you later!');
});
// app.intent('RebootDevice - yes', (conv, body) => {
//     console.log('====', body, '====');
//     conv.add('RebootDevice - yes!');
// });
